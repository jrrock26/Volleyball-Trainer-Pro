...
import { useExpoRecorder } from '../hooks/useExpoRecorder';
...
const runPlayWithOptionalRecording = async (record: boolean) => {
  try {
    if (record) {
  ...
  <View style={styles.container}>
    ...
    >
      ...
      <View style={styles.returnRow}>
        <View style={[styles.returnBall, { opacity: 0 }]} pointerEvents="none" />
        <View
          style={[
            styles.returnBall,
    ...
    <View style={styles.bottomControls}>
      ...
      <TouchableOpacity
        ...
        onPress={() => setShowRecordPrompt(true)}
      >
        <Text style={styles.controlBtnText}>Run Play</Text>
      </TouchableOpacity>

      {showRecordPrompt && (
        <View style={styles.recordModal}>
          <View style={styles.recordModalBox}>
            <Text style={styles.recordModalTitle}>Record this play?</Text>

            <TouchableOpacity
              style={styles.recordOption}
              onPress={() => {
                setShowRecordPrompt(false);
                runPlayWithOptionalRecording(true);
              }}
            >
              <Text style={styles.recordOptionText}>Screen Record Play</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                setShowRecordPrompt(false);
                runPlayWithOptionalRecording(false);
              }}
            >
              <Text style={styles.recordOptionText}>Run Play</Text>
            </TouchableOpacity>

            <TouchableOpacity
              style={styles.recordCancel}
              onPress={() => setShowRecordPrompt(false)}
            >
