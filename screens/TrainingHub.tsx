...
const btnTrainingBuilder = require('../assets/images/trainingbuilder.png');
const btnTrainingGenerator = require('../assets/images/traininggenerator.png');
const btnTrainingLibrary = require('../assets/images/traininglibrary.png');
const btnSavedTraining = require('../assets/images/savedtraining.png');

Asset.fromModule(bgModule).downloadAsync();
Asset.fromModule(btnTrainingBuilder).downloadAsync();
Asset.fromModule(btnTrainingGenerator).downloadAsync();
Asset.fromModule(btnTrainingLibrary).downloadAsync();
Asset.fromModule(btnSavedTraining).downloadAsync();
    ...
    >
      <View style={styles.overlay}>
        ...
        <View style={styles.row}>
          <GlowButton
            img={btnTrainingBuilder}
            onPress={() => navigation.navigate('TrainingBuilder')}
          />
          <GlowButton
            img={btnTrainingGenerator}
            onPress={() => navigation.navigate('TrainingGenerator')}
          />
        </View>
        ...
        <View style={styles.row}>
          <GlowButton
            img={btnTrainingLibrary}
            onPress={() => navigation.navigate('Training')}
          />
          <GlowButton
            img={btnSavedTraining}
            onPress={() => navigation.navigate('SavedTraining')}
          />
        </View>
